    ...
    return (
        <Container className={`pt-[5rem] md:pt-[10rem] ${S.header}`}>
            <Container className="container relative z-[1] flex justify-between flex-wrap">
                <Container className=' w-full md:w-1/2 shrink-0 pt-0 lg:pt-10'>
                    <Container as='h1' className='text-3xl md:text-5xl xl:text-6xl font-extrabold mb-2 md:mb-8'>
                    ...
                    <Container className=' mt-10 flex items-center gap-2 md:gap-4'>
                ...
                <Container className=' mt-10 w-full md:w-1/2 shrink-0 flex justify-center md:justify-end pl-0 md:pl-3 md:mt-0 '>
                    <Container className='w-[15rem] h-[15rem] md:w-[21rem] md:h-[21rem] lg:w-[23rem] lg:h-[23rem] xl:w-[25rem] xl:h-[25rem] border-[1px] border-slate-500 border-dashed rounded-full relative'>
                        ...
                        <Container as='span' className='w-[12rem] h-[10rem] md:w-[16rem] md:h-[15rem] lg:w-[18rem] lg:h-[17rem] xl:w-[20rem] xl:h-[19rem] animate-fading-pulse overflow-hidden absolute rounded-xl z-[2] -bottom-3 -right-1 lg:-right-5'>
