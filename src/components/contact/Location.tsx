            ...
            <Container className='container'>
                <Container className=' bg-slate-50 w-full md:w-2/3 lg:w-[55%] mx-auto rounded-md px-9 py-12'>
                    <Container className=' flex items-center gap-8 mb-7'>
                        ...
                        <Container>
                            <Container as='h4' className=' text-slate-800 font-semibold text-2xl'>Location:</Container>
                            <Container as='p' className='text-theme-blue'>No 14, Oba Ovoranwen Street, Gwarimpa Estate, Abuja, Nigeria.</Container>
                        </Container>
                    </Container>
                    <Container className=' flex items-center gap-8 mb-7'>
                        <Container as='span' className=" flex items-center justify-center w-8 h-8 rounded-full bg-blue-200">
                        ...
                        <Container>
                            <Container as='h4' className=' text-slate-800 font-semibold text-2xl'>Email:</Container>
                            <Container as='p' className='text-theme-blue'>info@15ctech.com</Container>
                        </Container>
                    </Container>
                    <Container className=' flex items-center gap-8 mb-7'>
                        <Container as='span' className=" flex items-center justify-center w-8 h-8 rounded-full bg-blue-200">
                        ...
                        <Container>
                            <Container as='h4' className=' text-slate-800 font-semibold text-2xl'>Call:</Container>
                            <Container as='p' className='text-theme-blue'>+234 80 3619 0155</Container>
                        </Container>
                    </Container>
                </Container>
